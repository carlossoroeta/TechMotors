...
public class MyVehiclesDelete extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
		...
		String username=(String)session.getAttribute("login");
            ...
            String LicensePlate = req.getParameter("id");
        ...
        int n = MyVehiclesData.MyVehiclesDelete(connection, LicensePlate);//es un method del ProductData
