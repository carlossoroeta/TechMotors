...
public class insertMyVehicle extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
		...
		int n1 = MyVehiclesData.getIDCustomer(connection, username);
		...
		int n = MyVehiclesData.insertMyVehicle(connection,n1,model,LicensePlate,BuyDate,OilDate,ITVDate,FilterDate);//es un method del ProductData
		res.setContentType("text/html");
