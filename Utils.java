public class Utils {
    public static String header(String username) {
        ...
        str.append("<div class='w3-right w3-hide-small'><a href='' class='w3-bar-item w3-button'>Services</a><a href='GarageList' class='w3-bar-item w3-button'>Garages</a><a href='chat' class='w3-bar-item w3-button'>Tech Community</a><a href='' class='w3-bar-item w3-button'>Contact</a></div>");
        str.append("</div>");
        return str.toString();
    }
	public static String managerheader(String username) {
        ...
        str.append("<div class='w3-bar w3-white w3-padding w3-card' style='letter-spacing:4px;'>");
        str.append("<div class='w3-right w3-hide-small'><a href='' class='w3-bar-item w3-button'>INFO</a><a href='Inventory' class='w3-bar-item w3-button'>Stock</a><a href='chat' class='w3-bar-item w3-button'>Tech Community</a><a href='' class='w3-bar-item w3-button'>Contact</a></div>");
        str.append("</div>");
        return str.toString();
    }
